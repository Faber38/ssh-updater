...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        for a in (self.act_check, self.act_sim, self.act_upg, self.act_clean, self.act_config, self.act_import):
            tb.addAction(a)
    ...
    def _on_clean(self):
        ...
        # Buttons sperren
        for a in (self.act_check, self.act_sim, self.act_upg, self.act_clean, self.act_config, self.act_import, self.act_clean):
            a.setEnabled(False)
